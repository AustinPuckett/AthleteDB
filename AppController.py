...
class AppController(tk.Tk):
    ...
    def __init__(self):
        ...
        self.views = {LoginView: {'model': AccountModel, 'presenter': LoginPresenter},
                           ...
                           WorkoutView: {'model': WorkoutModel, 'presenter': WorkoutPresenter},
                           ExerciseView: {'model': ExerciseModel, 'presenter': ExercisePresenter},
                           WorkoutSessionView: {'model': WorkoutSessionModel, 'presenter': WorkoutSessionPresenter},
                           ExerciseSessionView: {'model': ExerciseSessionModel, 'presenter': ExerciseSessionPresenter},
                           DateView: {'model': DateModel, 'presenter': DatePresenter},
                           GoalView: {'model': GoalModel, 'presenter': GoalPresenter},
                           ExerciseGoalView: {'model': ExerciseGoalModel, 'presenter': ExerciseGoalPresenter},
                           WorkoutClassGoalView: {'model': WorkoutClassGoalModel, 'presenter': WorkoutClassGoalPresenter},
                           WeightGoalView: {'model': WeightGoalModel, 'presenter': WeightGoalPresenter},
                           GlossaryView: {'model': EmptyModel, 'presenter': TextPagePresenter},
                           ProgramInfoView: {'model': EmptyModel, 'presenter': TextPagePresenter},
                           FAQView: {'model': EmptyModel, 'presenter': TextPagePresenter},
                           TableDataView: {'model': TableDataModel, 'presenter': TableDataPresenter}
                           }
